		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'min'                    => 0,
					'fields'                 => array(),
					'button_title'           => esc_html__( 'Add New', 'wp-tabs' ),
			...
			if ( ! empty( $this->parent ) && preg_match( '/' . preg_quote( '[' . $this->field['id'] . ']' ) . '/', $this->parent ) ) {
				...
				echo '<div class="wptabspro-notice wptabspro-notice-danger">' . esc_html__( 'Error: Nested field id can not be same with another nested field id.', 'wp-tabs' ) . '</div>';
				...
				echo '<i class="wptabspro-cloneable-remove wptabspro-confirm fa fa-times" data-confirm="' . esc_html__( 'Are you sure to delete this item?', 'wp-tabs' ) . '"></i>';
				echo '</div>';
				...
				echo '<div class="wptabspro-cloneable-alert wptabspro-cloneable-max">' . esc_html__( 'You can not add more than', 'wp-tabs' ) . ' ' . esc_attr( $args['max'] ) . '</div>';
				echo '<div class="wptabspro-cloneable-alert wptabspro-cloneable-min">' . esc_html__( 'You can not remove less than', 'wp-tabs' ) . ' ' . esc_attr( $args['min'] ) . '</div>';
