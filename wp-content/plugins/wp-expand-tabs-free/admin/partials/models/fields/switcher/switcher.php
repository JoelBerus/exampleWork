...
if ( ! class_exists( 'SP_WP_TABS_Field_switcher' ) ) {
	...
	class SP_WP_TABS_Field_switcher extends SP_WP_TABS_Fields {
		...
		public function render() {
			...
			$text_on    = ( ! empty( $this->field['text_on'] ) ) ? $this->field['text_on'] : esc_html__( 'On', 'wp-tabs' );
			$text_off   = ( ! empty( $this->field['text_off'] ) ) ? $this->field['text_off'] : esc_html__( 'Off', 'wp-tabs' );
