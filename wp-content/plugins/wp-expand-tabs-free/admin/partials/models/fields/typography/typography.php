	...
	class SP_WP_TABS_Field_typography extends SP_WP_TABS_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Font Family', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'wp-tabs' ) );
				echo '</div>';
			}
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Backup Font Family', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Font Style', 'wp-tabs' ) . '</div>';
				echo '<select class="wptabspro--font-style-select" data-placeholder="Default">';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'wp-tabs' ) : '' ) . '</option>';
				...
				if ( ! empty( $args['extra_styles'] ) ) {
					...
					echo ( ! $this->chosen ) ? '<div class="wptabspro--title">' . esc_html__( 'Load Extra Styles', 'wp-tabs' ) . '</div>' : '';
					$placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'wp-tabs' ) : esc_html__( 'Default', 'wp-tabs' );
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Subset', 'wp-tabs' ) . '</div>';
				$subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'wp-tabs' ), $args['multi_subset'] );
				echo '</div>';
			}
			...
			if ( ! empty( $args['text_align'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Text Align', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select(
					array(
						'inherit' => esc_html__( 'Inherit', 'wp-tabs' ),
						'left'    => esc_html__( 'Left', 'wp-tabs' ),
						'center'  => esc_html__( 'Center', 'wp-tabs' ),
						'right'   => esc_html__( 'Right', 'wp-tabs' ),
						'justify' => esc_html__( 'Justify', 'wp-tabs' ),
						'initial' => esc_html__( 'Initial', 'wp-tabs' ),
					),
					'text-align',
					esc_html__( 'Default', 'wp-tabs' )
				);
			...
			if ( ! empty( $args['font_variant'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Font Variant', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select(
					array(
						'normal'         => esc_html__( 'Normal', 'wp-tabs' ),
						'small-caps'     => esc_html__( 'Small Caps', 'wp-tabs' ),
						'all-small-caps' => esc_html__( 'All Small Caps', 'wp-tabs' ),
					),
					'font-variant',
					esc_html__( 'Default', 'wp-tabs' )
				);
			...
			if ( ! empty( $args['text_transform'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Text Transform', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select(
					array(
						'none'       => esc_html__( 'None', 'wp-tabs' ),
						'capitalize' => esc_html__( 'Capitalize', 'wp-tabs' ),
						'uppercase'  => esc_html__( 'Uppercase', 'wp-tabs' ),
						'lowercase'  => esc_html__( 'Lowercase', 'wp-tabs' ),
					),
					'text-transform',
					esc_html__( 'Default', 'wp-tabs' )
				);
			...
			if ( ! empty( $args['text_decoration'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Text Decoration', 'wp-tabs' ) . '</div>';
				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				echo $this->create_select(
					array(
						'none'               => esc_html__( 'None', 'wp-tabs' ),
						'underline'          => esc_html__( 'Solid', 'wp-tabs' ),
						'underline double'   => esc_html__( 'Double', 'wp-tabs' ),
						'underline dotted'   => esc_html__( 'Dotted', 'wp-tabs' ),
						'underline dashed'   => esc_html__( 'Dashed', 'wp-tabs' ),
						'underline wavy'     => esc_html__( 'Wavy', 'wp-tabs' ),
						'underline overline' => esc_html__( 'Overline', 'wp-tabs' ),
						'line-through'       => esc_html__( 'Line-through', 'wp-tabs' ),
					),
					'text-decoration',
					esc_html__( 'Default', 'wp-tabs' )
				);
			...
			if ( ! empty( $args['font_size'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Font Size', 'wp-tabs' ) . '</div>';
			...
			if ( ! empty( $args['line_height'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Line Height', 'wp-tabs' ) . '</div>';
				echo '<div class="wptabspro--input-wrap">';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Letter Spacing', 'wp-tabs' ) . '</div>';
				echo '<div class="wptabspro--input-wrap">';
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				echo '<div class="wptabspro--block">';
				echo '<div class="wptabspro--title">' . esc_html__( 'Word Spacing', 'wp-tabs' ) . '</div>';
				echo '<div class="wptabspro--input-wrap">';
			...
			if ( ! empty( $args['color'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Font Color', 'wp-tabs' ) . '</div>';
				...
				if ( ! empty( $args['hover_color'] ) ) {
					...
					echo '<div class="wptabspro--block wptabspro--block-font-color">';
					echo '<div class="wptabspro--title">' . esc_html__( 'Font Hover Color', 'wp-tabs' ) . '</div>';
					echo '<div class="wptabspro-field-color">';
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				...
				if ( ! empty( $args['active_color'] ) ) {
					...
					echo '<div class="wptabspro--block wptabspro--block-font-color">';
					echo '<div class="wptabspro--title">' . esc_html__( 'Font Active Color', 'wp-tabs' ) . '</div>';
					echo '<div class="wptabspro-field-color">';
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			...
			if ( ! empty( $args['custom_style'] ) ) {
				...
				echo '<div class="wptabspro--title">' . esc_html__( 'Custom Style', 'wp-tabs' ) . '</div>';
			...
			if ( ! wp_script_is( 'wptabspro-webfontloader' ) ) {
				...
				if ( ! empty( $customwebfonts ) ) {
					$webfonts['custom'] = array(
						'label' => esc_html__( 'Custom Web Fonts', 'wp-tabs' ),
						'fonts' => $customwebfonts,
					);
				}

				$webfonts['safe'] = array(
					'label' => esc_html__( 'Safe Web Fonts', 'wp-tabs' ),
					'fonts' => apply_filters(
				...
				$webfonts['google'] = array(
					'label' => esc_html__( 'Google Web Fonts', 'wp-tabs' ),
					'fonts' => apply_filters(
