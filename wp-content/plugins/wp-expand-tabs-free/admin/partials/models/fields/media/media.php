		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'remove_button'  => true,
					'library'        => array(),
					'button_title'   => esc_html__( 'Upload', 'wp-tabs' ),
					'remove_title'   => esc_html__( 'Remove', 'wp-tabs' ),
			...
			$placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="' . esc_html__( 'No media selected', 'wp-tabs' ) . '"' : '';
