;(function( $, window, document, undefined ) {
  ...
  $('.post-type-sp_wp_tabs .column-shortcode input').click(function (e) {
    e.preventDefault();
    /* Get the text field */
    var copyText = $(this);
  ...
  $('.sp-tab__shortcode-selectable').click(function (e) {
    e.preventDefault();
  ...
  function sp_tab_SelectText(element) {
    ...
    $('.wp_tabs_export .wptabspro--button').click(function (event) {
      event.preventDefault();
    ...
    // Tabs import.
    $('.wp_tabs_import button.import').click(function (event) {
      event.preventDefault();
