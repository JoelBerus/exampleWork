...
class WP_Tabs_Premium_Page {
	...
	public function happy_users( $username = 'shapedplugin', $args = array() ) {
		if ( $username ) {
			...
			$data = array(
				'error' => __( 'No data found!', 'wp-tabs' ),
			);
		}
				...
				<div class="row">
					<div class="sp-tabs__col-xl-6">
						<div class="sp-tabs__banner-content">
							<h2 class="sp-tabs__font-30 main-color sp-tabs__font-weight-500"><?php esc_html_e( 'Upgrade To WP Tabs Pro', 'wp-tabs' ); ?></h2>
							<h4 class="sp-tabs__mt-10 sp-tabs__font-18 sp-tabs__font-weight-500"><?php echo wp_kses_post( 'Supercharge <strong>Your Tabs Page or Section</strong> with powerful functionality!', 'wp-tabs' ); ?></h4>
							<p class="sp-tabs__mt-25 text-color-2 line-height-20 sp-tabs__font-weight-400"><?php esc_html_e( 'A highly flexible and customizable WordPress tabs plugin designed for everyone including designers & developers.', 'wp-tabs' ); ?></p>
							...
							<p class="sp-tabs__mt-25 text-color-2 line-height-20 sp-tabs__font-weight-400"><?php esc_html_e( 'You can also create tabs from existing WordPress posts, pages, taxonomy, and much more.', 'wp-tabs' ); ?></p>
						</div>
			...
			<div class="sp-tabs__container">
				...
				<div class="video-area text-center">
					...
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/J6jIZlkGRMA">
